        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <motion.img src="/LogoWicho3.png" alt="Wicho Landscaping" className="w-12 sm:w-14 md:w-16 lg:w-18 xl:w-20 h-auto rounded-xl"
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full bg-white p-6 sm:max-w-sm">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <img src="/LogoWicho3.png" alt="Wicho Landscaping" className="w-12 sm:w-14 md:w-16 lg:w-18 xl:w-20 h-auto rounded-xl" />
              </a>
              <button
