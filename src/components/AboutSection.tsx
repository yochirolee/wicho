...
export default function AboutWithStats() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      />
      <div className="absolute inset-0 -z-10 bg-black/60"></div> {/* <-- Agregado aquí */}
      <div
        aria-hidden="true"
      ...
      >
        <div
          ...
          className="aspect-1097/845 w-[68.5rem] bg-gradient-to-tr from-[#a8e063] to-[#56ab2f] opacity-20"
        />
      </div>
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">
            At <span className="font-semibold text-white">Wicho Landscaping</span>, we bring passion, precision, and professionalism to every outdoor space.
